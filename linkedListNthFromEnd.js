...
//#endregion
//control + shift + [ to fold code once it's indented
...
//This method has bad space complexity
const get_nt_from_end = (list, n) => {
...
console.log(get_nt_from_end(list, 3));

//Better space complexity would be a solution involving pointers